...
python pipeline.py --count 5 --channel tech

# 6. Or run with cron for daily automation
crontab -e
# Add: 0 6 * * * cd ~/shorts-automation && python pipeline.py --count 2 --channel tech --auto-upload
```
